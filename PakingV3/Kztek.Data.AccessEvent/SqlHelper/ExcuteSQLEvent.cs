...
namespace Kztek.Data.AccessEvent.SqlHelper
{
    public static class ExcuteSQLEvent
    {
        ...
        private static string connStr = ConfigurationManager.ConnectionStrings["KztekAccessEventEntities"].ConnectionString;
        /// <summary>
