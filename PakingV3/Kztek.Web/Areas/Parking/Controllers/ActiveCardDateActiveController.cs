...
{
    public class ActiveCardDateActiveController : Controller
    {
        ...
        public JsonResult ExtendAllCard(ActiveCardCustomViewModel obj)
        {
            ...
            try
            {
                ...
                var isSuccess = _tblCardService.AddCardDateActive(obj.KeyWord, obj.AnotherKey, obj.CardGroup, "", obj.CustomerGroup, int.Parse(fee), dateextend, GetCurrentUser.GetUser().Id, obj.isAllowNegativeDays);
        ...
        public JsonResult ExtendSelectedCard(ActiveCardCustomViewModel obj)
        {
            ...
            try
            {
                ...
                if (list != null && list.Any())
                {
                    ...
                    isSuccess = _tblCardService.AddCardDateActiveByListCardNumber(cardnumbers, int.Parse(fee), dateextend, GetCurrentUser.GetUser().Id, obj.isAllowNegativeDays);
                }
                else
                {
