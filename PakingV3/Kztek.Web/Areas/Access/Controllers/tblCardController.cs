...
namespace Kztek.Web.Areas.Access.Controllers
{
    public class tblCardController : Controller
    {
        ...
        public ActionResult Index(string key, string cardgroups, string customerid, string customergroups, string active, string fromdate, string todate, string isCheckByTime = "0", int page = 1, string chkExport = "0", string selectedId = "", string levels = "", bool desc = true, string columnQuery = "ImportDate")
        {
            ...
            if (chkExport == "1")
            {
                var listExcel = _tblCardService.GetAccessExcelCardByFirstTSQL(key, cardgroups, customerid, str, fromdate, todate, desc, columnQuery, isCheckByTime);
            ...
            var list = _tblCardService.GetAllPagingByFirstTSQL(key, cardgroups, customerid, str, fromdate, todate,desc, columnQuery, ref total, isCheckByTime, page, pageSize, levels);
